  ...
  async store(req, res) {
    ...
    if (!isProvider) {
      return res.status(401).json({
        error: 'Only service providers can made appointments!',
      });
    }

    // parseISO converte o valor de data para um objeto data e startOfHour vai pegar a hora de inicio
    ...
    // Checar disponibilidade da data
    const checkAvability = await Appointment.findOne({
      where: {
        provider_id,
        canceled_at: null,
        date: hourStart,
